################################################################################################################################## 
# Define ENSO metrics plots, borrowed from PCMDI Diagnostic Package 
# (https://raw.githubusercontent.com/PCMDI/pcmdi_metrics/refs/heads/main/pcmdi_metrics/enso/lib/summary_plot_lib/EnsoPlotLib.py)
################################################################################################################################## 
...
plot_parameters = {
    ...
    "BiasSshLatRmse": {
        ...
        "dive_down01": {
            "plot_type": "map",
            "nbr_panel": 2,
            "colorbar": dict_colorbar[
                "SST"
            ],  # YYP: I do not know yet the colobar / label needed
    ...
    "EnsodSstOce": {
        ...
        "dive_down01": {
            ...
            "colors": {
                "model": ["black", "red", "blue"],
                "reference": ["black", "red", "blue"],
            },
    ...
    "EnsoFbSshSst": {
        "netcdf_variables": [
            ...
            "sst__",
            "ssh_over_sst_lon__",
            "sshPOS_over_sst_lon__",
            "sshNEG_over_sst_lon__",
            "ssh_over_sst_hov__",
            "sshPOS_over_sst_hov__",
            "sshNEG_over_sst_hov__",
        ],
        "diagnostic": {
    ...
    "EnsoFbSstLhf": {
        "netcdf_variables": [
            ...
            "lhf__",
            "sst_over_lhf_lon__",
            "sstPOS_over_lhf_lon__",
            "sstNEG_over_lhf_lon__",
            "sst_over_lhf_hov__",
            "sstPOS_over_lhf_hov__",
            "sstNEG_over_lhf_hov__",
        ],
        "diagnostic": {
            "plot_type": "scatterplot",
            "nbr_panel": 1,
    ...
    "EnsoFbSstLwr": {
        "netcdf_variables": [
            ...
            "lwr__",
            "sst_over_lwr_lon__",
            "sstPOS_over_lwr_lon__",
            "sstNEG_over_lwr_lon__",
            "sst_over_lwr_hov__",
            "sstPOS_over_lwr_hov__",
            "sstNEG_over_lwr_hov__",
        ],
        "diagnostic": {
            "plot_type": "scatterplot",
            "nbr_panel": 1,
    ...
    "EnsoFbSstShf": {
        "netcdf_variables": [
            ...
            "shf__",
            "sst_over_shf_lon__",
            "sstPOS_over_shf_lon__",
            "sstNEG_over_shf_lon__",
            "sst_over_shf_hov__",
            "sstPOS_over_shf_hov__",
            "sstNEG_over_shf_hov__",
        ],
        "diagnostic": {
            "plot_type": "scatterplot",
            "nbr_panel": 1,
    ...
    "EnsoFbSstSwr": {
        "netcdf_variables": [
            ...
            "swr__",
            "sst_over_swr_lon__",
            "sstPOS_over_swr_lon__",
            "sstNEG_over_swr_lon__",
            "sst_over_swr_hov__",
            "sstPOS_over_swr_hov__",
            "sstNEG_over_swr_hov__",
        ],
        "diagnostic": {
            "plot_type": "scatterplot",
            "nbr_panel": 1,
    ...
    "EnsoFbSstTaux": {
        "netcdf_variables": [
            ...
            "taux__",
            "sst_over_taux_lon__",
            "sstPOS_over_taux_lon__",
            "sstNEG_over_taux_lon__",
            "sst_over_taux_hov__",
            "sstPOS_over_taux_hov__",
            "sstNEG_over_taux_hov__",
        ],
        "diagnostic": {
            "plot_type": "scatterplot",
            "nbr_panel": 1,
    ...
    "EnsoFbSstThf": {
        "netcdf_variables": [
            ...
            "thf__",
            "sst_over_thf_lon__",
            "sstPOS_over_thf_lon__",
            "sstNEG_over_thf_lon__",
            "sst_over_thf_hov__",
            "sstPOS_over_thf_hov__",
            "sstNEG_over_thf_hov__",
        ],
        "diagnostic": {
            "plot_type": "scatterplot",
            "nbr_panel": 1,
    ...
    "EnsoFbTauxSsh": {
        "netcdf_variables": [
            ...
            "ssh__",
            "taux_over_ssh_lon__",
            "tauxPOS_over_ssh_lon__",
            "tauxNEG_over_ssh_lon__",
            "taux_over_ssh_hov__",
            "tauxPOS_over_ssh_hov__",
            "tauxNEG_over_ssh_hov__",
        ],
        "diagnostic": {
            "plot_type": "scatterplot",
            "nbr_panel": 1,
    ...
    "EnsoSstDiversity": {
        ...
        "dive_down01": {
            ...
            "yname": [
                "longitude of min/max SSTA",
                "longitude of min SSTA",
                "longitude of max SSTA",
            ],
...
def default_arg_values(arg):
    ...
    try:
        ...
        raise KeyError(f"Unknown argument '{arg}'. Valid keys: {list(default)}")
    
def plot_param(metric_collection, metric):
    dict_MC = defCollection(metric_collection)
    dict_MCm = dict_MC["metrics_list"][metric]
    # get plot parameters
    dict_out = plot_parameters[
        metric.replace("_1", "").replace("_2", "").replace("_3", "")
    ]
    ...
    if metric_collection in ["ENSO_tel", "test_tel"] and "Map" in metric:
        ...
        try:
            ...
            try:
                computation = dict_MC["common_collection_parameters"][
                    "metric_computation"
                ]
            except KeyError:
    ...
    """
    # If the same reference is repeated, then remove repeated
    if "_" in refname:
        parts = refname.split("_")
        # Use a set to remove duplicates and then join back to a string
